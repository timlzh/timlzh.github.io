/*! SKPlayer */ ! function (t, e) {
    ...
    return function (t) {
        ...
        function n(t, e) {
            ...
            if (e && "function" == typeof btoa) {
                ...
                return [n].concat(r.sources.map(function (t) {
                    return "/github-archive/*# sourceURL=" + r.sourceRoot + t + " */"
                })).concat([s]).join("\n")
            }
            return [n].join("\n")
        }
        ...
        function o(t) {
            return "/github-archive/*# sourceMappingURL=data:application/json;charset=utf-8;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(t)))) + " */"
        }
        ...
        t.exports = function (t) {
            ...
            var n = e.protocol + "//" + e.host,
                o = n + e.pathname.replace(/\/[^\/]*$/, "/github-archive/");
            return t.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (t, e) {
                ...
                var s;
                return s = 0 === r.indexOf("//") ? r : 0 === r.indexOf("/github-archive/") ? n + r : o + r.replace(/^\.\//, ""), "url(" + JSON.stringify(s) + ")"
            })
        }
    }])
});
